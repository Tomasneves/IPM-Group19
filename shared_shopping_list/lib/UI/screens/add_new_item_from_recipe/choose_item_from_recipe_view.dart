...
class ChooseItemFromRecipeView
  ...
  const ChooseItemFromRecipeView(this.listId, this.recipeId, {Key? key}) : super(key: key);
  ...
  @override
  Widget builder(BuildContext context, ChooseItemFromRecipeViewModel viewModel, Widget? child) {
          ...
          children: [
            ...
            SingleChildScrollView(
              child: DataTable(
                ...
                rows: recipe.items.map((e) => DataRow(
                  cells: <DataCell>[
            ...
            const SizedBox(height: 30),
            BlueButton(text: "Add selected", onTap: () => viewModel.addSelectedItemsAndGoBack(listId, recipeId),),
          ],
        ),
      )),
    );
